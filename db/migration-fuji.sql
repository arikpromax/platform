...
insert into public.sites (id, slug, name, paid_until, config) values (
  ...
  '{"collections":[{"key":"menu","name":"Страви","fields":[{"type":"text","key":"title","name":"Назва страви","hint":"Так її побачить покупець. Наприклад: Філадельфія з лососем"},{"type":"text","key":"price","name":"Ціна, грн","hint":"Саме число, без слова «грн». Наприклад: 279"},{"type":"text","key":"promo","name":"Ціна за акцією, грн","extra":true,"hint":"Заповніть, щоб запустити акцію: на сайті стара ціна стане закресленою, поруч зʼявиться нова і жовта плашка «АКЦІЯ». Щоб акцію прибрати — очистіть це поле. Приклад: звичайна 279, тут 199."},{"type":"image","key":"image","name":"Фото страви","hint":"Якщо фото немає — сайт намалює умовну картинку сам. Щойно завантажите фото, воно замінить малюнок."},{"type":"select-collection","key":"cat","name":"У якому розділі показувати","from":"cats","extra":true,"hint":"«Сети» тут не обирайте — сети редагуються на своїй вкладці."},{"type":"text","key":"w","name":"Вага і кількість","extra":true,"hint":"Наприклад: 8 шт · 250 г"},{"type":"textarea","key":"d","name":"Опис (склад)","extra":true,"hint":"Своїми словами, через кому. Наприклад: лосось, крем-сир, огірок"},{"type":"checkbox","key":"top","name":"Хіт — показати на головній сторінці","extra":true,"hint":"Такі страви потрапляють у блок «Топові позиції» на головній."},{"type":"checkbox","key":"neu","name":"Новинка","extra":true,"hint":"Над фото зʼявиться червона плашка «НОВИНКА»."},{"type":"checkbox","key":"hot","name":"Гостре","extra":true,"hint":"Плашка «ГОСТРЕ»."},{"type":"checkbox","key":"veg","name":"Без риби","extra":true,"hint":"Плашка «БЕЗ РИБИ» — для тих, хто рибу не їсть."},{"type":"checkbox","key":"add","name":"Пропонувати перед оформленням","extra":true,"hint":"Для соусів, паличок і напоїв. Такі позиції покупець бачить окремим списком на кроці перед оформленням замовлення."},{"type":"select","key":"t","name":"Який малюнок малювати","options":[{"value":"roll","label":"Рол (зріз)"},{"value":"baked","label":"Запечений"},{"value":"tempura","label":"Темпура"},{"value":"nigiri","label":"Суші / нігірі"},{"value":"shrimp","label":"Креветки"},{"value":"bowl","label":"Вок (миска)"},{"value":"drink","label":"Напій"},{"value":"sauce","label":"Соус"},{"value":"stick","label":"Палички"},{"value":"set","label":"Сет (три роли)"}],"extra":true,"hint":"Потрібно, лише поки немає фото."},{"type":"text","key":"ing","name":"Кольори начинки на малюнку","extra":true,"hint":"Технічне поле — можна не чіпати."}]},{"key":"sets","name":"Сети","fields":[{"type":"text","key":"title","name":"Назва сета","hint":"Без слова «Сет» — воно додасться саме. Наприклад: Титан"},{"type":"text","key":"price","name":"Ціна, грн","hint":"Саме число, без слова «грн». Наприклад: 999"},{"type":"text","key":"promo","name":"Ціна за акцією, грн","extra":true,"hint":"Заповніть, щоб запустити акцію: на сайті стара ціна стане закресленою, поруч зʼявиться нова і жовта плашка «АКЦІЯ». Щоб акцію прибрати — очистіть це поле. Приклад: звичайна 279, тут 199."},{"type":"image","key":"image","name":"Фото сета","hint":"Якщо фото немає — сайт намалює умовну картинку сам."},{"type":"text","key":"pcs","name":"Скільки шматочків","extra":true,"hint":"Наприклад: 48 шт. Можна лишити порожнім."},{"type":"text","key":"w","name":"Вага","extra":true,"hint":"Наприклад: 1650 г. Можна лишити порожнім."},{"type":"textarea","key":"list","name":"Що входить у сет","extra":true,"hint":"Кожна позиція з нового рядка. Саме цей список покупець бачить на картці сета."},{"type":"checkbox","key":"week","name":"Сет тижня","extra":true,"hint":"Над фото зʼявиться золота плашка «СЕТ ТИЖНЯ»."},{"type":"checkbox","key":"top","name":"Хіт — показати на головній сторінці","extra":true},{"type":"text","key":"ing","name":"Кольори начинки на малюнку","extra":true,"hint":"Технічне поле — можна не чіпати."}]},{"key":"cats","name":"Розділи меню","noAdd":true,"noDelete":true,"fields":[{"key":"title","name":"Назва розділу","type":"text","hint":"Так він підписаний на сайті. Наприклад: Запечені"},{"key":"image","name":"Кругла картинка розділу","type":"image","hint":"Показується над назвою в стрічці розділів. Не завантажите — сайт намалює свою."},{"key":"catkey","name":"Код розділу — не міняйте","type":"text","extra":true,"hint":"Технічний звʼязок зі стравами. Якщо змінити, розділ спорожніє."}]},{"key":"banners","name":"Банери на головній","fields":[{"type":"text","key":"title","name":"Заголовок на банері","hint":"Великий напис. Наприклад: Сет «Гранд»"},{"type":"textarea","key":"text","name":"Підпис під заголовком","hint":"Один-два короткі рядки. Наприклад: Вісім позицій: класика, вугор, гарячі роли та хрумкі креветки"},{"type":"image","key":"image","name":"Фото банера","hint":"Не завантажите — сайт намалює картинку сам або візьме фото повʼязаної позиції."},{"type":"text","key":"item","name":"Яку позицію додає кнопка","extra":true,"hint":"Впишіть назву точно так, як вона названа в меню чи сетах — наприклад: Сет «Гранд». Якщо лишити порожнім або помилитися в назві, кнопка просто поведе в меню."},{"type":"text","key":"ing","name":"Кольори начинки на малюнку","extra":true,"hint":"Технічне поле — можна не чіпати."}]},{"key":"settings","name":"Режим роботи","noAdd":true,"noDelete":true,"fields":[{"type":"text","key":"title","name":"Службова назва — не міняйте"},{"type":"text","key":"open_from","name":"Приймаємо замовлення з","extra":true,"hint":"Година у форматі 10:00. На головній зʼявиться зелена позначка «зараз відчинено», а поза цим часом — «зачинено, відкриємось о…». Замовити все одно можна."},{"type":"text","key":"open_to","name":"Приймаємо замовлення до","extra":true,"hint":"Година у форматі 22:00. Цим же обмежується вибір часу в оформленні замовлення."},{"type":"checkbox","key":"dayoff","name":"СЬОГОДНІ НЕ ПРАЦЮЄМО — закрити сайт","extra":true,"hint":"Поставте галочку зранку: замість меню відвідувач побачить екран «Сьогодні вихідний» з вашим телефоном і замовити не зможе. Наступного дня галочку зніміть."},{"type":"text","key":"msg","name":"Що написати великими літерами","extra":true,"hint":"Наприклад: Сьогодні вихідний"},{"type":"text","key":"msg2","name":"Пояснення дрібнішим шрифтом","extra":true,"hint":"Наприклад: Понеділок — санітарний день. Чекаємо завтра з 10:00"}]}],"texts":[{"key":"hours","name":"Графік роботи","hint":"Показується на головній і внизу сайту. Наприклад: вт–нд з 10:00 до 22:00"},{"key":"dayoff_note","name":"Примітка про вихідний","hint":"Наприклад: Понеділок — санітарний день"},{"key":"phone_view","name":"Телефон — як показувати","hint":"Наприклад: (098) 000 77 92"},{"key":"phone","name":"Телефон — для дзвінка","hint":"Той самий номер, але суцільно і з кодом країни. Наприклад: +380980007792"},{"key":"free_from","name":"Безкоштовна доставка від, грн","hint":"Саме число. Наприклад: 499"},{"key":"min_order","name":"Мінімальне замовлення, грн","hint":"Менше цієї суми кошик не дасть оформити. Наприклад: 250"},{"key":"far_km","name":"З якого кілометра починається доплата","hint":"Наприклад: 10"},{"key":"far_fee","name":"Доплата за кожен кілометр, грн","hint":"Наприклад: 15"},{"key":"pickup_time","name":"Самовиніс: за скільки готуємо","hint":"Наприклад: 30–40 хв"}],"sections":[{"name":"1. Режим роботи","note":"Тут закривають сайт на день і задають години прийому замовлень. Страви й ціни — у наступних вкладках.","collections":["settings"],"texts":["hours","dayoff_note","phone_view","phone"]},{"name":"2. Страви","note":"Усі позиції меню, крім сетів. Щоб змінити ціну або запустити акцію — натисніть «Редагувати» біля потрібної страви.","collections":["menu","cats"]},{"name":"3. Сети","note":"Великі набори. Ціна, склад і акції — так само, як у стравах.","collections":["sets"]},{"name":"4. Банери на головній","note":"Великі картки вгорі головної сторінки, які гортаються. Можна додавати нові й прибирати зайві — крапки під ними перерахуються самі.","collections":["banners"]},{"name":"5. Доставка та оплата","note":"Суми й умови, які покупець бачить у кошику та в розділі «Доставка та оплата».","texts":["free_from","min_order","far_km","far_fee","pickup_time"]}]}'::jsonb
)
...
insert into public.items (site_id, collection, title, extra, sort_order)
select v.* from (values
  (5, 'settings', 'Режим роботи', '{"dayoff":false,"msg":"Сьогодні вихідний","msg2":"Понеділок — санітарний день","open_from":"10:00","open_to":"22:00"}'::jsonb, 1)
) as v(site_id, collection, title, extra, sort_order)
...
select v.* from (values
  (5, 'banners', 'Сет «Гранд»', 'Вісім позицій: класика, вугор, гарячі роли та хрумкі креветки', '{"item":"Сет «Гранд»","ing":"losos,vuhor,tunec,krab,krev"}'::jsonb, 1),
  (5, 'banners', 'Сет «Титан»', '48 шматочків, 1650 г. Сім видів ролів в одній коробці', '{"item":"Сет «Титан»","ing":"losos,tunec,krev,black"}'::jsonb, 2),
  (5, 'banners', 'Філадельфія «Аляска»', 'Лосось зверху, крем-сир, авокадо та варена креветка', '{"item":"Філадельфія «Аляска»","ing":"losos,syr,avo,krev"}'::jsonb, 3),
  (5, 'banners', 'Сет «Макі»', 'Шість видів макі, 660 г. Найлегший спосіб почати', '{"item":"Сет «Макі»","ing":"losos,tunec,krev,ohir,syr"}'::jsonb, 4)
) as v(site_id, collection, title, text, extra, sort_order)
where not exists (select 1 from public.items where site_id = 5 and collection = 'banners');
