...
update public.items set extra =
  '{"open_from":"10:00","open_to":"22:00","open_msg":"зараз відчинено, приймаємо до","shut_msg":"зараз зачинено, відкриємось о"}'::jsonb || extra
...
-- Написи про режим роботи переїхали в картку «Режим роботи», до годин:
