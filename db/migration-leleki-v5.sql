-- ============================================================
--  МІГРАЦІЯ v5: Кінний двір «Лелеки» — прибрати панель
--  «Включено у вартість» З АДМІНКИ (на сайті смужка лишається).
--  Перезаписує лише список розділів адмінки (sections) — той самий,
--  що у v4, але без колекції "included" у розділі «Про комплекс».
