...
// Кирилицю в запиті віддаємо \u-втечами. Спершу здавалось, що це лікує
// «Р—Р°РјРѕРІ…» на сторінці оплати, але причина була інша: псувався сам файл
// функції при передачі власнику на заливку. Втечі лишив — вони нічого не
// коштують і страхують від непорозумінь із кодуванням на тому боці.
